...
import { Loader2, Plus, Edit, Trash2, ImageIcon, ExternalLink, Hammer, BookOpen } from 'lucide-react'
                  ...
                  <tr key={product.id} className="border-b hover:bg-muted/50">
                    ...
                    <td className="py-3 px-4">
                      <div className="flex gap-2">
                        ...
                        <Link href={`/admin/products/${product.id}/tutorials`}>
                          <Button size="sm" variant="outline"><BookOpen className="h-3 w-3 mr-1" />Tutorials</Button>
                        </Link>
