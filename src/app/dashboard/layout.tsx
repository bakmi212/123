...
const menuItems = [
  ...
  { icon: Gift, label: 'Affiliate', href: '/dashboard/affiliate' },
        ...
        <header className="sticky top-0 z-30 h-16 bg-white/80 backdrop-blur-md border-b border-slate-200">
          <div className="h-full px-4 lg:px-8 flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 ml-auto">
              {/* Notifications */}
              <Link href="/dashboard/notifications" className="relative p-2 hover:bg-slate-100 rounded-lg transition-colors">
