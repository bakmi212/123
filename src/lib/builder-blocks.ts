...
export function getDefaultBlockContent(type: string): Record<string, any> {
  ...
  switch (type) {
    ...
    case 'pricing': return { title: 'Simple Pricing', price: 'Rp 149.000', period: 'one-time', features: ['Feature 1', 'Feature 2', 'Feature 3'], buttonText: 'Buy Now', highlighted: false, align: 'center', actions: defaultActions }
    ...
    case 'offer_stack': return { items: [{ title: 'Main Product', price: 'Rp 149.000', description: 'Core offering' }], totalText: 'Total Value:', actions: defaultActions }
